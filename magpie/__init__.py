...
from magpie.base.word2vec import train_word2vec, fit_scaler, fit_scaler_mongo
from magpie.config import NN_ARCHITECTURE, BATCH_SIZE, EMBEDDING_SIZE, NB_EPOCHS
from magpie.nn.input_data import get_data_for_model, get_data_for_model_mongo
